...
|---|---|---|---|---|
| 0 | Governance, reproducible local environment, CI and decisions | Verified clean baseline | Fresh install/check, local services, governance consistency, S0 controls | IN PROGRESS |
| 1 | Canonical contracts, deterministic policy and atomic ledger without signing | Phase 0 internal consistency | Unit, DB, concurrency, property and idempotency proof | PLANNED |

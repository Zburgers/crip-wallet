...
(`npm run check`: 21 repository + 363 package tests; DB: 158/158). It adds
...
envelope replacement, autonomous retries, and approval replays. Exact-SHA MAX review and protected CI/Secret Scan are

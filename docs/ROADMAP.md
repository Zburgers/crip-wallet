...
| 2 | Construct/verify/simulate/sign/reconcile fake ERC-20 on Anvil | S1 | Chain vertical slice and reconciliation evidence | **OPEN - P2-01 READY; P2-02 BLOCKED ON ADR-0015** |
...
The implementation-ready packet plan is `docs/plans/PHASE-2.md`. Proposed ADR-0015 must be accepted before exact EVM envelope/signing work begins; this does not block the P2-01 local fake-token fixture.

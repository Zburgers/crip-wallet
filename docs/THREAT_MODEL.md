...
agent-facing path. The MVP trusted
...
| T-004 | Duplicate broadcast                          | Authenticated evidence, durable lifecycle, hash/nonce recovery                                                                                               | TM-004        |
...
| T-018 | Sign timeout or signed-unbroadcast ambiguity | Authenticated recovery, quarantine, disputed reservation, recovery fence                                                                                     | TM-018        |
| T-019 | Broadcast timeout before persistence         | Authenticated evidence, search known hash/nonce before retry                                                                                                 | TM-019        |

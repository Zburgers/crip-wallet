...
| WS-005 Approval/controls — integrated execution slice | 3 | IN PROGRESS / P3-01 through P3-03 CLEARED; P3-04 local gates pass, exact-SHA review/CI pending | Stable WS-004 boundary |
...
WS-004 is accepted only inside the local fake-money boundary. Phase 3 preserves
that provider-neutral/local-only scope and follows `docs/plans/PHASE-3.md`.

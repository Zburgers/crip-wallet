...
tests) and `npm run test:db` passes 156/156, including concurrent duplicate
recovery, forced final-lease expiry rollback, and control/recovery/envelope-
replacement/autonomous-retry lock-order races. Exact-SHA MAX review and protected CI/Secret Scan

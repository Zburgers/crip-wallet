...
| Phase-3 integrated controls | ADR-0018 is accepted; P3-01 passed MAX review and exact-SHA CI/Secret Scan. P3-02 uses migrations `0027`/`0028` for signed/no-attempt quarantine, exact accepted-attempt recovery after control, replay-safe control request IDs, and all attempt-status audits. Static, DB 144/144, and concurrency 18/18 pass locally; exact-SHA MAX review/CI remain pending. P3-03–P3-06 remain gated. | **IN PROGRESS / P3-02 REVIEW PENDING** |

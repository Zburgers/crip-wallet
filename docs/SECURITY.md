...
| S2 local E2E | Phase 2 / WS-004 is open. P2-06A is integrated/accepted and P2-06B/C are externally accepted on `integration/p2-06bc`; P2-06D and final S2 closeout remain pending under the ADR-0015 boundary | **OPEN / NOT PASSED** |

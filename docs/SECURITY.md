...
| Phase-3 integrated controls | ADR-0018 is accepted; P3-01 through P3-03 passed exact-SHA review and protected CI/Secret Scan. P3-04 local candidate adds DB-time lease renewal/fencing, exact signed-no-attempt recovery, and control/recovery lock-order race coverage; `npm run check` passes (21 repo + 363 package tests), DB passes 154/154. P3-04 exact-SHA review and protected CI/Secret Scan are pending; P3-05/06 remain gated. | **IN PROGRESS / P3-04 LOCAL GATES PASS** |

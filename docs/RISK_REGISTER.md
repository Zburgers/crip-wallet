...
| R-027 | `ALLOW_AUTONOMOUS` cannot create canonical authorization without fabricated approval | Critical | **MITIGATED FOR P2-05D / EXTERNAL ACCEPTANCE:** ADR-0016 canonical authorization, persisted immutable decision/hash/fence binding, shared invalidation, race/forgery tests, and clean production-writer E2E; P2-06 adversarial matrices remain separate |
| R-028 | Signer-local bytes are discarded before the accepted broadcaster can send them | Critical | **MITIGATED FOR P2-05D / EXTERNAL ACCEPTANCE:** ADR-0017 same-child signer/broadcaster composition, volatile raw bytes, durable signed evidence before STARTED/send, exact frozen vector and clean E2E; P2-06 fault matrices remain separate |

...
| R-030 | Pause/revoke after signed evidence or an alternate raw sender still reaches broadcast | Critical | **PARTIALLY MITIGATED LOCALLY / OPEN:** P3-02 migration `0027` quarantines signed/no-attempt work and fences a new `STARTED` attempt; P3-03 still owns full authority revalidation and sole-sender proof before closure |

...
| P0-004 | Fresh npm install/static/test gate | PLANNED | Scaffold not yet validated |
| P0-005 | PostgreSQL/Anvil clean local startup | PLANNED | Compose not yet validated |
